...
!insertmacro LANG_STRING INSTALL_DIRECTORY "Répertoire d'installation"
!insertmacro LANG_STRING INSTALL_DIRECTORY_EXPLANATION "Cliquer ici pour changer le répertoire où le logiciel sera installé."
