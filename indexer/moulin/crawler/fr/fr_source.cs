namespace WikiMoulin {
    ...
    class WikiLangMap {
		...
		s_ns.Add ("Wikisource", 4);
		s_ns.Add ("Discussion Wikisource", 5);
		s_ns.Add ("Image", 6);
		...
		s_ns.Add ("Transwiki", 100);
		s_ns.Add ("Discussion Transwiki", 101);
		s_ns.Add ("Page", 104);
		s_ns.Add ("Discussion Page", 105);
		s_ns.Add ("Livre", 112);
		s_ns.Add ("Discussion Livre", 113);
      	}
 }
}
