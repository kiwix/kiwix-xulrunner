...
INCLUDED_PROJECTS = [
{:url => "http://es.wikipedia.org/wiki/Catégorie:", :internal => "moulin://encyclopedia-category/fr/"},
{:url => "http://es.wikipedia.org/wiki/Portail:", :internal => "moulin://encyclopedia-portal/fr/"},
{:url => "http://es.wikipedia.org/wiki/Référence:", :internal => "moulin://encyclopedia-appendix/fr/"},
