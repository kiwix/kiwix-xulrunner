...
public class RemoteConnection extends AsyncTask<Void,Void,JSONObject> {
    ...
    protected JSONObject doInBackground(Void... params) {
        String urlString = ""+ Constants.DOMAIN +"/w/api.php?action="+action+"&format=json&title="+postTo+"&section=new&sectiontitle=[["+title+"]]&text="+text+"&basetimestamp=2006-08-24T12%3A34%3A54.000Z"; // URL to call
