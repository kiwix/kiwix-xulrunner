...
var PipeChannel = function(URI) {
  ...
  this.request = this.inputStreamChannel.QueryInterface
(Ci.nsIRequest);
  this.channel = this.inputStreamChannel.QueryInterface
(Ci.nsIChannel);
  ...
  get INHIBIT_PERSISTENT_CACHING() {return
this.request.INHIBIT_PERSISTENT_CACHING},
  ...
  get VALIDATE_ONCE_PER_SESSION() {return
this.request.VALIDATE_ONCE_PER_SESSION},
  ...
  get LOAD_RETARGETED_DOCUMENT_URI() {return
this.channel.LOAD_RETARGETED_DOCUMENT_URI},
  get LOAD_REPLACE() {return this.channel.LOAD_REPLACE},
  get LOAD_INITIAL_DOCUMENT_URI() {return
this.channel.LOAD_INITIAL_DOCUMENT_URI},
  ...
  get notificationCallbacks() {return
this.channel.notificationCallbacks},
  set notificationCallbacks(val) {this.channel.notificationCallbacks =
val},
