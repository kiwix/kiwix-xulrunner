...
function getZoomInButton() {
    return document.getElementById("button-zoom-in");
}

function getZoomOutButton() {
    return document.getElementById("button-zoom-out");
}
...
function getLaunchIndexingMenuItem() {
    return document.getElementById("tools-launchIndexing");
}

function getLoadRandomArticleMenuItem() {
    return document.getElementById("tools-randomArticle");
}

function getPurgeHistoryMenuItem() {
    return document.getElementById("tools-purgeHistory");
}
...
function getInvertedColorsMenuItem() {
    return document.getElementById("display-inverted-colors");
}
...
function activateHomeButton() {
    activateToolbarButton(getHomeButton());
}

function desactivateHomeButton() {
    desactivateToolbarButton(getHomeButton());
}

function activateFullscreenButton() {
    activateToolbarButton(getFullscreenButton());
}

function desactivateFullscreenButton() {
    desactivateToolbarButton(getFullscreenButton());
}

function activateBackButton() {
    activateToolbarButton(getBackButton());
}

function desactivateBackButton() {
    desactivateToolbarButton(getBackButton());
}

function activateNextButton() {
    activateToolbarButton(getNextButton());
}

function desactivateNextButton() {
    desactivateToolbarButton(getNextButton());
}
